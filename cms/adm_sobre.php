<?php
   ...
   if(isset($_GET['status'])){
        ...
        if($status == "ativado"){
            ...
            $sqlTeste = "UPDATE tbl_sobre SET status = 1";
                ...
                <table id="tabela">
                    ...
                    <tr>
                        ...
                        <td id="td_imagens">
                            ...
                            <a href="adm_sobre.php?modo=excluir&id=<?= $rsContatos['idSobre'] ?>">
                            ...
                            ?>
                            <a href="adm_sobre.php?status=ativado&id=<?= $rsContatos['idSobre'] ?>">
                                <img src="imagens/ativado.png">
                            </a>
                            <?php } else { ?>
                            <a href="adm_sobre.php?status=desativado&id=<?= $rsContatos['idSobre'] ?>">
